...
<c:url var="URL" value="/v1/admin/students?pageNo=1&pageSize=10&hoVaTen=&gioiTinh=&quocGia=viet+nam&doiTuongUuTien=&hocBong=&heDaoTao=&coSoDaoTao="></c:url>

<c:url var="URLCHANGE" value="/v1/admin/students/add"></c:url>
