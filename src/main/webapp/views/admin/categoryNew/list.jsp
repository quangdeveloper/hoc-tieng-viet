...
<c:url var="DELETEAPI" value="/v1/api/admin/categories"></c:url>
<c:url var="URL" value="/v1/admin/categories"></c:url>
<c:url var="URLCHANGE" value="/v1/admin/categories/add"></c:url>
<c:url var="URLSearch" value="/v1/admin/categories/searchs"></c:url>
<html>
<head>
    <title></title>
</head>
                            ...
                            <table>
                                <tr>
                                    <c:set var="padding" value="padding: 5px 5px 5 px 5px;
                                                                text-align: center"/>
                                    <td style="${padding}">Mã danh mục</td>
                                    <td style="${padding}">Tên danh mục</td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input style="width: ${width};
                                            ...
                                            height: 35px; " type="text" name="maDanhMuc"></td>
                                    ...
                                    <td><input style="width:200px;
                                            ...
                                            -webkit-transition: width 0.4s ease-in-out;
                                            transition: width 0.4s ease-in-out;
                                            height: 35px; " type="text" name="tenDanhMuc"></td>
